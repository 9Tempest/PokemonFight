...
-- Create a GeometryNode with MeshId = 'sphere', and name = 'head'.
sphereMesh2 = gr.mesh('sphere', 'name-of-sphere2')
sphereMesh2:scale(0.5, 0.5, 0.5)
sphereMesh2:translate(0.8, 0.5, -5.0)
sphereMesh2:set_material(gr.material({0.4, 0.8, 0.4}, {0.8, 0.8, 0.8}, 50.0))
rootNode:add_child(sphereMesh2)
